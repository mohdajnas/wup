    ...
    >
      {hasTarget && (
        <Handle
          ...
          className="!h-2.5 !w-2.5 !border-border !bg-gray-200"
        />
      )}
          ...
          {slots.map((slot) => (
            ...
            >
              ...
              <Handle
                ...
                className="!relative !right-auto !top-auto !h-2.5 !w-2.5 !translate-x-[12px] !transform-none !border-border !bg-gray-200"
              />
            </div>
          ))}
        </div>
