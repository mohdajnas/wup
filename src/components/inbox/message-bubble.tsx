...
function MediaUnavailable({ label }: { label: string }) {
  return (
    <div className="flex items-center gap-2 rounded-lg bg-gray-200/40 px-3 py-2 text-xs text-muted-foreground">
    ...
    case "document":
      ...
      return (
        <a
          ...
          className="flex items-center gap-2 rounded-lg bg-gray-200/50 px-3 py-2 text-sm hover:bg-muted"
        >
