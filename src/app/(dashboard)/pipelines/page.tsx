...
export default function PipelinesPage() {
  ...
  const seedDefaultPipeline = useCallback(async (): Promise<Pipeline | null> => {
    ...
    // We need user.id because user_id is still a NOT NULL column in pipelines
    // even though account_id is used for RLS.
  ...
  useEffect(() => {
    ...
    (async () => {
      setLoading(true);
      // Wait for the profile to settle before attempting a seed —
      // without accountId the insert would violate RLS.
  ...
  }, [loadPipelines, seedDefaultPipeline, profileLoading]);
