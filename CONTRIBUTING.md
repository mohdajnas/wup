...
```bash
# 1. Fork on GitHub: https://github.com/mohdajnas/wup → Fork
# 2. Clone your fork
...
```bash
git remote add upstream https://github.com/mohdajnas/wup.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/mohdajnas/wup/issues/new?template=bug_report.yml)
